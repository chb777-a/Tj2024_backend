...
public class Example1 {
	public static void main(String[] args) {
		//1. 동물 인스턴스 ( 객체 ) 생성
		동물 animal = new 동물(); // 생성자 실행
		animal.showMe(); // Object 생성자 --> [[동물 생성자 탄생]] , myName : 동물
		...
		//3. 참새 인스턴스(객체) 생성 , *** 하위 하위 클래스의 생성자를 호출하면 상위 클래스의 생성자가 호출된다.
		...
		//참새 sparrow2 = animal; // 동물 타입의 자료(객체)가 참새 타입으로 변환이 안 된다.
		//조류 bird3 = animal; // 동물 타입의 자료(객체)가 조류 타입으로 변환이 안 된다.
